...
map_type = 'original'  # 'lines', 'blobs', 'boxes'
...
class Env():
    ...
    def __init__(self, args):
        ...
        self.denormalize_action_factor = 4  # so max/min speed is -4 to 4
        ## For the Agent
        self.max_step = 4000  # 2000
    ...
    def interpretate_action(self, action):
        ...
        '''
        # TODO: coloquei assim abaixo pq quando tiver uma nova acao (prob done) vou multiplicar por 1
        ...
        # The following is not in use anymore because action now will not be above 1 our below -1
    ...
    def step(self, action):
        ...
        self.reward = self.calculate_reward(action, prev_map)
    ...
    def calculate_reward(self, action, prev_map):
